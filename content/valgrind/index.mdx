...
description: This post describes the strategy we can employ to detect bad stack usages such as buffer overflows.
date: '2019-02-10'
tags: ['valgrind']
image: ''
author: 'Paul Semel'
...
![Chunk supposed size after array access](valgrind-memory.png)
